...
SRC_URI += "file://0005-remove-msoft-float-from-PLATFORM_RELFLAGS.patch \
            file://0006-change-bootcmd-to-use-stage_boot.patch \
"

SRC_URI_append_388-db-gp = "file://0001-Revert-bin_header_debug-add-XOR-engine-based-memtest.patch \
